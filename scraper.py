...
async def main(limit=5):
    async with async_playwright() as p:
        ...
        people_url = "https://www.linkedin.com/company/baazi-games/people/"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Scrape LinkedIn profiles from Gameskraft company page")
    parser.add_argument("--limit", type=int, default=5, help="Number of profiles to scrape (default: 5)")
